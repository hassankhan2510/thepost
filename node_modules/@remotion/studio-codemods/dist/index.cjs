...
var getVideoConfigIdentifierValues = ({
  ...
  recast3.types.visit(ast, {
    visitVariableDeclarator(path) {
      ...
      const isVideoConfigDeclaration = id.type === "ObjectPattern" && init?.type === "CallExpression" && init.callee.type === "Identifier" && init.callee.name === "useVideoConfig" && init.arguments.length === 0;
...
var getNestedPropStatus = ({
  ...
  const attr = jsxElement.attributes.find((a2) => a2.type !== "JSXSpreadAttribute" && a2.name.type !== "JSXNamespacedName" && a2.name.name === parentKey);
  if (!attr || !attr.value) {
...
var getNodePathRemappings = ({
  ...
  const nodePathRemappings = captured.flatMap(({ node, nodePath }) => {
    ...
    if (newNodePath !== null && JSON.stringify(nodePath) === JSON.stringify(newNodePath)) {
      return [];
    }
...
var b6 = recast11.types.builders;
var n = recast11.types.namedTypes;
...
// src/recast-mods.ts
var b7 = recast12.types.builders;
var applyCodemod = ({
  file,
  codeMod
}) => {
  ...
  return {
    ...
    openingElement: {
      ...
      attributes: [
        ...
        jsxAttributeWithExpression2("component", b7.identifier(transformation.componentName)),
        jsxAttributeWithExpression2("durationInFrames", b7.numericLiteral(transformation.newDurationInFrames)),
        jsxAttributeWithExpression2("fps", b7.numericLiteral(transformation.newFps)),
        jsxAttributeWithExpression2("width", b7.numericLiteral(transformation.newWidth)),
        jsxAttributeWithExpression2("height", b7.numericLiteral(transformation.newHeight))
      ],
      selfClosing: true
    },
    closingElement: null,
...
var changeComposition2 = ({
  ...
  const attributes = openingElement.attributes.map((attribute) => {
    ...
    if (attribute.name.name === "fps" && newCompositionFps !== null) {
      ...
      return {
        ...attribute,
        value: b7.jsxExpressionContainer(b7.numericLiteral(newCompositionFps))
      };
    }
    if (attribute.name.name === "durationInFrames" && newCompositionDurationInFrames !== null) {
      ...
      return {
        ...attribute,
        value: b7.jsxExpressionContainer(b7.numericLiteral(newCompositionDurationInFrames))
      };
    }
    if (attribute.name.name === "width" && newCompositionWidth !== null) {
      ...
      return {
        ...attribute,
        value: b7.jsxExpressionContainer(b7.numericLiteral(newCompositionWidth))
      };
    }
    if (attribute.name.name === "height" && newCompositionHeight !== null) {
      ...
      return {
        ...attribute,
        value: b7.jsxExpressionContainer(b7.numericLiteral(newCompositionHeight))
      };
    }
    return attribute;
  }).filter(Boolean);
  if (newCompositionFps !== null && !attributes.some((attribute) => attribute.type === "JSXAttribute" && attribute.name.type === "JSXIdentifier" && attribute.name.name === "fps")) {
    ...
    attributes.push(jsxAttributeWithExpression2("fps", b7.numericLiteral(newCompositionFps)));
  }
  if (newCompositionDurationInFrames !== null && !attributes.some((attribute) => attribute.type === "JSXAttribute" && attribute.name.type === "JSXIdentifier" && attribute.name.name === "durationInFrames")) {
    ...
    attributes.push(jsxAttributeWithExpression2("durationInFrames", b7.numericLiteral(newCompositionDurationInFrames)));
  }
  if (newCompositionWidth !== null && !attributes.some((attribute) => attribute.type === "JSXAttribute" && attribute.name.type === "JSXIdentifier" && attribute.name.name === "width")) {
    ...
    attributes.push(jsxAttributeWithExpression2("width", b7.numericLiteral(newCompositionWidth)));
  }
  if (newCompositionHeight !== null && !attributes.some((attribute) => attribute.type === "JSXAttribute" && attribute.name.type === "JSXIdentifier" && attribute.name.name === "height")) {
    ...
    attributes.push(jsxAttributeWithExpression2("height", b7.numericLiteral(newCompositionHeight)));
  }
...
var { namedTypes: namedTypes2 } = recast13.types;
...
var getOldValueString = ({
  ...
  if (attr) {
    ...
    if (objExpr) {
      ...
      if (prop) {
        return recast14.print(prop.value).code;
      }
    }
  }
  ...
  if (attr) {
    ...
    if (objExpr) {
      ...
      if (prop) {
        ...
        objExpr.properties.push(b8.objectProperty(b8.identifier(childKey), parsedValue));
      }
    }
  } else {
    const parsedValue = createValueExpression ? createValueExpression(null) : parseValueExpression(value);
    const objExpr = b8.objectExpression([
      b8.objectProperty(b8.identifier(childKey), parsedValue)
    ]);
    const newAttr = b8.jsxAttribute(b8.jsxIdentifier(parentKey), b8.jsxExpressionContainer(objExpr));
...
var getTopLevelReturnStatement = (statements) => {
  ...
  for (const statement of statements) {
    if (recast15.types.namedTypes.ReturnStatement.check(statement)) {
...
var createSequenceElement = () => {
  return recast15.types.builders.jsxElement(recast15.types.builders.jsxOpeningElement(recast15.types.builders.jsxIdentifier("Sequence"), []), recast15.types.builders.jsxClosingElement(recast15.types.builders.jsxIdentifier("Sequence")), []);
};
var createSequenceWithChild = ({
  child,
  sequenceLocalName
}) => {
  return recast15.types.builders.jsxElement(recast15.types.builders.jsxOpeningElement(recast15.types.builders.jsxIdentifier(sequenceLocalName), []), recast15.types.builders.jsxClosingElement(recast15.types.builders.jsxIdentifier(sequenceLocalName)), [child]);
};
var createNumberAttribute = (name, value) => {
  return recast15.types.builders.jsxAttribute(recast15.types.builders.jsxIdentifier(name), recast15.types.builders.jsxExpressionContainer(recast15.types.builders.numericLiteral(value)));
};
var createStringAttribute = (name, value) => {
  return recast15.types.builders.jsxAttribute(recast15.types.builders.jsxIdentifier(name), recast15.types.builders.stringLiteral(value));
};
var createBooleanAttribute = (name, value) => {
  return recast15.types.builders.jsxAttribute(recast15.types.builders.jsxIdentifier(name), recast15.types.builders.jsxExpressionContainer(recast15.types.builders.booleanLiteral(value)));
};
...
var createStyleAttribute = (properties) => {
  return recast15.types.builders.jsxAttribute(recast15.types.builders.jsxIdentifier("style"), recast15.types.builders.jsxExpressionContainer(recast15.types.builders.objectExpression(properties)));
};
var getPositionStyleProperties = (position) => {
  const properties = [
    recast15.types.builders.objectProperty(recast15.types.builders.identifier("position"), recast15.types.builders.stringLiteral("absolute"))
  ];
  if (position) {
    properties.push(recast15.types.builders.objectProperty(recast15.types.builders.identifier("translate"), recast15.types.builders.stringLiteral(formatTranslateValue(position))));
  }
  return properties;
};
...
var createAssetStyleAttribute = ({
  ...
  return createStyleAttribute([
    ...
    ...dimensions ? [
      recast15.types.builders.objectProperty(recast15.types.builders.identifier("width"), recast15.types.builders.numericLiteral(dimensions.width)),
      recast15.types.builders.objectProperty(recast15.types.builders.identifier("height"), recast15.types.builders.numericLiteral(dimensions.height))
    ] : []
  ]);
};
var createStaticFileSrcAttribute = ({
  ...
  return recast15.types.builders.jsxAttribute(recast15.types.builders.jsxIdentifier("src"), recast15.types.builders.jsxExpressionContainer(recast15.types.builders.callExpression(recast15.types.builders.identifier(staticFileLocalName), [recast15.types.builders.stringLiteral(src)])));
};
...
var createStringSrcAttribute = (src) => {
  return recast15.types.builders.jsxAttribute(recast15.types.builders.jsxIdentifier("src"), recast15.types.builders.stringLiteral(src));
};
var createSolidElement = ({
  ...
  return recast15.types.builders.jsxElement(recast15.types.builders.jsxOpeningElement(recast15.types.builders.jsxIdentifier(localName), [
...
var createSequenceWrappedElement = ({
  ...
  return recast15.types.builders.jsxElement(recast15.types.builders.jsxOpeningElement(recast15.types.builders.jsxIdentifier(sequenceLocalName), [
    ...from === null ? [] : [createNumberAttribute("from", from)],
    ...
    createPositionAbsoluteStyleAttribute(position)
  ], false), recast15.types.builders.jsxClosingElement(recast15.types.builders.jsxIdentifier(sequenceLocalName)), [child]);
};
...
var createSvgElement = async ({
  ...
  const interactiveSvgName = () => recast15.types.builders.jsxMemberExpression(recast15.types.builders.jsxIdentifier(interactiveLocalName), recast15.types.builders.jsxIdentifier("Svg"));
...
var createFragmentWithElement = (element) => {
  return recast15.types.builders.jsxFragment(recast15.types.builders.jsxOpeningFragment(), recast15.types.builders.jsxClosingFragment(), [element]);
};
...
var hasTopLevelBinding = ({ ast, name }) => {
...
var addOfficialNamedImport = ({
  ...
  const importSpecifier = recast15.types.builders.importSpecifier(recast15.types.builders.identifier(importedName));
  if (existingImport) {
    existingImport.specifiers = [
      ...existingImport.specifiers ?? [],
      importSpecifier
  ...
  const importDeclaration = recast15.types.builders.importDeclaration([importSpecifier], recast15.types.builders.stringLiteral(sourcePath));
  insertImportDeclaration(ast, importDeclaration);
};
...
var ensureDefaultImport = ({
  ...
  const importSpecifier = recast15.types.builders.importDefaultSpecifier(recast15.types.builders.identifier(localName));
...
var createExpressionAttribute = (name, value) => {
  return recast15.types.builders.jsxAttribute(recast15.types.builders.jsxIdentifier(name), recast15.types.builders.jsxExpressionContainer(parseValueExpression(value)));
};
...
var createCompositionObjectProperty = ({
  ...
  return recast15.types.builders.objectProperty(identifierRegex.test(name) ? recast15.types.builders.identifier(name) : recast15.types.builders.stringLiteral(name), parseValueExpression(value));
};
var createCompositionComponentElement = ({
  ...
  const attributes = [
    ...
    ...spreadProperties.length === 0 ? [] : [
      recast15.types.builders.jsxSpreadAttribute(recast15.types.builders.objectExpression(spreadProperties))
    ]
  ];
  return recast15.types.builders.jsxElement(recast15.types.builders.jsxOpeningElement(recast15.types.builders.jsxIdentifier(localName), attributes, true), null, []);
};
...
var addElementToComponentRoot = ({
  ...
  if (rootNode.type === "JSXElement") {
    const existingRoot = rootNode.openingElement.selfClosing ? createSequenceWithChild({
      child: stripParenthesizedExtra(rootNode),
      sequenceLocalName: ensureSequenceImport(ast)
    }) : stripParenthesizedExtra(rootNode);
    const fragment = recast15.types.builders.jsxFragment(recast15.types.builders.jsxOpeningFragment(), recast15.types.builders.jsxClosingFragment(), [existingRoot, element]);
    let replaced = false;
    recast15.types.visit(ast, {
      visitJSXElement(astPath) {
...
var { builders: b9, namedTypes: namedTypes3 } = recast16.types;
...
var numericAttribute = (name, value) => ({
  ...
  value: {
    type: "JSXExpressionContainer",
    expression: value === Infinity ? b9.identifier("Infinity") : b9.numericLiteral(value)
  }
});
...
var cloneJsxElement = (element) => {
  const printed = recast16.print(element).code;
...
var insertAfter = (parentNode, node, clone) => {
  ...
  if (namedTypes3.ReturnStatement.check(parentNode)) {
    ...
    if (parent.argument === node) {
      parent.argument = makeFragment2(node, clone);
      return true;
    }
  }
  if (namedTypes3.ArrowFunctionExpression.check(parentNode)) {
    const parent = parentNode;
    if (parent.body === node) {
      parent.body = makeFragment2(node, clone);
      return true;
    }
  }
  return false;
...
var splitJsxSequence = async ({
  ...
  if (!insertAfter(parentPath.node, jsxElement, right)) {
    jsxPath.replace(makeFragment2(jsxElement, right));
  }
  const finalFile = serializeAst(ast);
  const { output, formatted } = await formatFile({
    contents: finalFile,
...
var { namedTypes: namedTypes4 } = recast17.types;
var audioProps = [
  "src",
  "from",
  "durationInFrames",
...
var insertAfter2 = (parentNode, node, sibling) => {
  ...
  if (namedTypes4.ReturnStatement.check(parentNode)) {
    const parent = parentNode;
    if (parent.argument === node) {
      parent.argument = makeFragment3(node, sibling);
      return true;
    }
  }
  if (namedTypes4.ArrowFunctionExpression.check(parentNode)) {
    const parent = parentNode;
    if (parent.body === node) {
      parent.body = makeFragment3(node, sibling);
      return true;
    }
  }
  return false;
...
var splitVideoFromAudio = async ({
  ...
  if (!insertAfter2(parentPath.node, jsxElement, audioElement)) {
    jsxPath.replace(makeFragment3(jsxElement, audioElement));
  }
  const finalFile = serializeAst(ast);
  const { output, formatted } = await formatFile({
    contents: finalFile,
...
var getStaticCaption = (expression) => {
  ...
  if (typeof text !== "string" || typeof startMs !== "number" || typeof endMs !== "number" || timestampMs !== null && typeof timestampMs !== "number" || confidence !== null && typeof confidence !== "number") {
...
var updateCaption = ({
  ...
  for (const key of changedKeys) {
    ...
    if (key === "text" && typeof value !== "string" || (key === "startMs" || key === "endMs") && (typeof value !== "number" || !Number.isFinite(value)) || (key === "timestampMs" || key === "confidence") && value !== null && (typeof value !== "number" || !Number.isFinite(value))) {
...
var updateInlineCaptionPatches = ({
  ...
  const output = replacements.sort((a2, b10) => b10.start - a2.start).reduce((current, replacement) => current.slice(0, replacement.start) + replacement.value + current.slice(replacement.end), input);
  return {
    output,
...
var b10 = recast19.types.builders;
...
var getInterpolationCalleeForValues = ({
  ...
  return b10.identifier(import_studio_shared6.getKeyframeInterpolationFunction({
    schema,
    key,
    staticValue,
    newValue
...
var createClampOptionsExpression = ({
  ...
  const properties = [
    b10.objectProperty(b10.identifier("extrapolateLeft"), b10.stringLiteral("clamp")),
    b10.objectProperty(b10.identifier("extrapolateRight"), b10.stringLiteral("clamp"))
  ];
  if (defaultOutput !== null && defaultOutput !== "linear") {
    properties.push(b10.objectProperty(b10.identifier("output"), b10.stringLiteral(defaultOutput)));
  }
  return b10.objectExpression(properties);
};
var createEmptyOptionsExpression = () => b10.objectExpression([]);
...
var setOptionsProperty = ({
  ...
  options.properties.push(b10.objectProperty(b10.identifier(propertyName), value));
};
...
var createEasingExpression = (easing) => {
  switch (easing.type) {
    case "linear":
      return b10.memberExpression(b10.identifier("Easing"), b10.identifier("linear"));
    case "step1":
      return b10.memberExpression(b10.identifier("Easing"), b10.identifier("step1"));
    case "spring":
      return b10.callExpression(b10.memberExpression(b10.identifier("Easing"), b10.identifier("spring")), [
        b10.objectExpression([
          b10.objectProperty(b10.identifier("damping"), parseValueExpression(easing.damping)),
          b10.objectProperty(b10.identifier("mass"), parseValueExpression(easing.mass)),
          b10.objectProperty(b10.identifier("stiffness"), parseValueExpression(easing.stiffness)),
          ...easing.allowTail === null ? [] : [
            b10.objectProperty(b10.identifier("allowTail"), b10.booleanLiteral(easing.allowTail))
          ],
          ...easing.durationRestThreshold === null ? [] : [
            b10.objectProperty(b10.identifier("durationRestThreshold"), parseValueExpression(easing.durationRestThreshold))
          ],
          b10.objectProperty(b10.identifier("overshootClamping"), b10.booleanLiteral(easing.overshootClamping))
        ])
      ]);
    case "bezier":
      return b10.callExpression(b10.memberExpression(b10.identifier("Easing"), b10.identifier("bezier")), [easing.x1, easing.y1, easing.x2, easing.y2].map((value) => parseValueExpression(value)));
    default:
      throw new Error(`Unsupported easing: ${JSON.stringify(easing)}`);
  }
};
var createEasingArrayExpression = (easing) => b10.arrayExpression(easing.map((easingValue) => createEasingExpression(easingValue)));
var setEasingOption = ({
  options,
  easing
}) => {
...
var updateKeyframeSettings = ({
  ...
  if (isColorInterpolation) {
    ...
    setOptionsProperty({
      ...
      value: b10.stringLiteral(clamping.left)
    });
    setOptionsProperty({
      options,
      propertyName: "extrapolateRight",
      value: b10.stringLiteral(clamping.right)
    });
  }
  if (!isColorInterpolation && output !== undefined) {
    setOptionsProperty({
      options,
      propertyName: "output",
      value: output === "linear" ? null : b10.stringLiteral(output)
    });
  }
  setOptionsProperty({
    options,
    propertyName: "posterize",
    value: posterize === undefined ? null : b10.numericLiteral(posterize)
  });
...
var createInterpolateExpression = ({
  ...
  return b10.callExpression(callee, [
    input,
    b10.arrayExpression(sortedKeyframes.map((keyframe) => keyframe.frame === keyframe.originalFrame ? keyframe.frameExpression : updateVideoConfigNumericExpression({
      expression: keyframe.frameNumericExpression,
      value: keyframe.frame
    }))),
    b10.arrayExpression(sortedKeyframes.map((keyframe) => keyframe.output)),
    ...extraArgs
  ]);
};
...
var addKeyframe = ({
  ...
  if (existing) {
    ...
    return {
      expression: createInterpolateExpression({
        callee: b10.identifier(nextCalleeName),
        input: existing.input,
...
var getExpressionFromJsxAttribute = (attr) => {
  if (!attr.value) {
    return b10.booleanLiteral(true);
  }
...
var findObjectProperty2 = (objExpr, propertyName) => {
...
var createJsxExpressionAttribute = (key, expression) => {
  return b10.jsxAttribute(b10.jsxIdentifier(key), b10.jsxExpressionContainer(expression));
};
var createObjectProperty = (key, value) => b10.objectProperty(b10.identifier(key), value);
var createObjectExpressionAttribute = ({
  parentKey,
  childKey,
  expression
}) => {
  return createJsxExpressionAttribute(parentKey, b10.objectExpression([
...
var getSequenceWritableProp = ({
  ...
  if (dotIndex === -1) {
    ...
    return {
      expression,
      setExpression: (nextExpression) => {
        topLevelAttr.value = b10.jsxExpressionContainer(nextExpression);
      },
      remove: () => {
        attributes.splice(attrIndex, 1);
      }
  ...
  const { propIndex, prop } = findObjectProperty2(objExpr, childKey);
  if (!prop) {
    if (missingPropInitialValue) {
      return {
        expression: createMissingPropExpression(missingPropInitialValue),
...
var getEffectWritableProp = ({
  ...
  const { propIndex, prop } = findObjectProperty2(objExpr, key);
  if (!prop) {
    if (missingPropInitialValue) {
      return {
        expression: createMissingPropExpression(missingPropInitialValue),
...
var getEffectPropsObjectExpression = (call2) => {
  if (call2.arguments.length === 0) {
    const objExpr = b10.objectExpression([]);
...
var updateSequenceKeyframesAst = ({
  ...
  for (const update of updates) {
    ...
    oldValueStrings.push(recast19.print(prop.expression).code);
    ...
    newValueStrings.push(recast19.print(nextExpression).code);
...
var b11 = recast20.types.builders;
...
var makeEasingExpression = ({
  ...
  switch (easing.type) {
    case "linear":
      return b11.memberExpression(b11.identifier(easingLocalName), b11.identifier("linear"));
    case "step1":
      return b11.memberExpression(b11.identifier(easingLocalName), b11.identifier("step1"));
    case "spring":
      return b11.callExpression(b11.memberExpression(b11.identifier(easingLocalName), b11.identifier("spring")), [
        b11.objectExpression([
          b11.objectProperty(b11.identifier("damping"), parseValueExpression(easing.damping)),
          b11.objectProperty(b11.identifier("mass"), parseValueExpression(easing.mass)),
          b11.objectProperty(b11.identifier("stiffness"), parseValueExpression(easing.stiffness)),
          ...easing.allowTail === null ? [] : [
            b11.objectProperty(b11.identifier("allowTail"), b11.booleanLiteral(easing.allowTail))
          ],
          ...easing.durationRestThreshold === null ? [] : [
            b11.objectProperty(b11.identifier("durationRestThreshold"), parseValueExpression(easing.durationRestThreshold))
          ],
          b11.objectProperty(b11.identifier("overshootClamping"), b11.booleanLiteral(easing.overshootClamping))
        ])
      ]);
    case "bezier":
      return b11.callExpression(b11.memberExpression(b11.identifier(easingLocalName), b11.identifier("bezier")), [easing.x1, easing.y1, easing.x2, easing.y2].map((value) => parseValueExpression(value)));
    default:
      throw new Error(`Unsupported easing: ${JSON.stringify(easing)}`);
  }
};
var makeOptionsExpression = ({
  ...
  if (param.interpolationFunction !== "interpolateColors") {
    if (param.clamping.left !== "extend") {
      properties.push(b11.objectProperty(b11.identifier("extrapolateLeft"), b11.stringLiteral(param.clamping.left)));
    }
    if (param.clamping.right !== "extend") {
      properties.push(b11.objectProperty(b11.identifier("extrapolateRight"), b11.stringLiteral(param.clamping.right)));
    }
    if (param.output === "perceptual-scale") {
      properties.push(b11.objectProperty(b11.identifier("output"), b11.stringLiteral(param.output)));
    }
  }
  if (param.easing.some((easing) => easing.type !== "linear")) {
    properties.push(b11.objectProperty(b11.identifier("easing"), b11.arrayExpression(param.easing.map((easing) => makeEasingExpression({
      easing,
      easingLocalName: localNames.Easing ?? "Easing"
    })))));
  }
  if (param.posterize !== undefined) {
    properties.push(b11.objectProperty(b11.identifier("posterize"), parseValueExpression(param.posterize)));
  }
  return properties.length === 0 ? null : b11.objectExpression(properties);
};
var makeClipboardParamExpression = ({
  ...
  const args = [
    b11.identifier("frame"),
    b11.arrayExpression(param.keyframes.map((keyframe) => parseValueExpression(keyframe.frame))),
    b11.arrayExpression(param.keyframes.map((keyframe) => parseValueExpression(keyframe.value)))
  ];
  const options = makeOptionsExpression({ param, localNames });
  if (options) {
    args.push(options);
  }
  return b11.callExpression(b11.identifier(localNames[param.interpolationFunction] ?? param.interpolationFunction), args);
};

// src/update-sequence-props.ts
var b12 = recast21.types.builders;
...
var snapshotTopLevelAttrs = (node) => {
  ...
  for (const a2 of node.attributes ?? []) {
    if (a2.type === "JSXAttribute" && a2.name.type === "JSXIdentifier") {
      const { name } = a2.name;
      const printed = recast21.print(a2).code.replace(/\s+/g, " ").replace(/,(\s*[}\]])/g, "$1").trim();
      const prefix = `${name}=`;
...
var isFunctionNode2 = (value) => {
  return recast21.types.namedTypes.FunctionDeclaration.check(value) || recast21.types.namedTypes.FunctionExpression.check(value) || recast21.types.namedTypes.ArrowFunctionExpression.check(value);
};
var ensureUseCurrentFrameHook2 = ({
  ...
  if (!recast21.types.namedTypes.BlockStatement.check(fn.body)) {
    fn.body = b12.blockStatement([
      b12.returnStatement(fn.body)
    ]);
  }
  const block = fn.body;
  ...
  block.body.unshift(b12.variableDeclaration("const", [
    b12.variableDeclarator(b12.identifier("frame"), b12.callExpression(b12.identifier(hookName), []))
  ]));
};
...
var updateJsxTextContent = ({
  ...
  if (staticChildrenAttribute) {
    ...
    childrenAttribute.value = b12.stringLiteral(nextValue);
...
`) && nextValue.trim() === nextValue;
  if (canRepresentAsJsxText) {
    jsxElement.children = [
      b12.jsxText(escapeJsxText(nextValue))
    ];
  } else {
    jsxElement.children = [
      b12.jsxExpressionContainer(b12.stringLiteral(nextValue))
    ];
  }
...
var ensureLoadFontImport = ({
  ...
  const specifier = b12.importSpecifier(b12.identifier("loadFont"), b12.identifier(localName));
  for (const statement of ast.program.body) {
  ...
  const declaration = b12.importDeclaration([specifier], b12.stringLiteral(moduleName));
...
var insertLoadFontCall = ({
  ...
  const call2 = b12.expressionStatement(b12.callExpression(b12.identifier(localName), [
    b12.stringLiteral(font.style),
    b12.objectExpression([
      b12.objectProperty(b12.identifier("weights"), b12.arrayExpression(font.weights.map((weight) => b12.stringLiteral(weight)))),
      b12.objectProperty(b12.identifier("subsets"), b12.arrayExpression(font.subsets.map((subset) => b12.stringLiteral(subset))))
    ])
  ]));
  call2.comments = [b12.commentLine(` ${googleFontLoadingComment}`)];
...
var migrateCssShorthand = ({
  ...
  for (let index = 0;index < properties.length; index++) {
    ...
    properties.splice(index, 1, ...cssShorthand.longhands.map((longhand) => {
      ...
      return b12.objectProperty(b12.identifier(longhand), typeof value === "number" ? b12.numericLiteral(value) : b12.stringLiteral(value));
    }));
  ...
  for (const { key, value, defaultValue, clipboardParam } of updates) {
    ...
    if (isNested) {
      ...
      if (attr && attr.type !== "JSXSpreadAttribute" && attr.value) {
        const printed = recast21.print(attr.value).code;
      ...
      if (isDefault) {
        ...
        const newValue = value === true && !clipboardParam ? null : b12.jsxExpressionContainer(parsed);
        if (!attr || attr.type === "JSXSpreadAttribute") {
          const newAttr = b12.jsxAttribute(b12.jsxIdentifier(key), newValue);
          if (!node.attributes) {
            node.attributes = [];
          }
...
`);
  ...
  const replacements = openingElementLocations ? [...openingElementLocations].map(([openingElement, location]) => {
    ...
    return {
      ...
      replacement: recast21.print(openingElement).code,
...
var visit3 = (value, visitor) => {
  if (Array.isArray(value)) {
    for (const item of value) {
      if (visit3(item, visitor)) {
        return true;
      }
    }
    return false;
...
var getJsxAttribute = (openingElement, name) => {
  return getNodes(openingElement, "attributes").find((attribute) => {
    return attribute.type === "JSXAttribute" && jsxName(getNode(attribute, "name")) === name;
  }) ?? null;
};
...
var jsxAttributeIdentifier = (attribute) => {
  const value = attribute ? getNode(attribute, "value") : null;
  const expression = value?.type === "JSXExpressionContainer" ? getNode(value, "expression") : null;
  return expression?.type === "Identifier" ? getString(expression, "name") : null;
};
var findDynamicImport = (attribute) => {
  let importPath = null;
  const value = attribute ? getNode(attribute, "value") : null;
  visit3(value, (node) => {
    if (node.type === "ImportExpression") {
    ...
    if (node.type === "CallExpression" && getNode(node, "callee")?.type === "Import") {
  ...
  for (const statement of programStatements(ast)) {
    ...
    for (const specifier of getNodes(statement, "specifiers")) {
      ...
      if (specifier.type === "ImportDefaultSpecifier") {
        return { exportName: "default", importPath: source };
      }
      if (specifier.type === "ImportSpecifier") {
        const imported = getNode(specifier, "imported");
        return {
          exportName: getString(imported, "name") ?? getString(imported, "value"),
          importPath: source
        };
      }
    }
...
var resolveReExport = ({
  ...
  for (const statement of programStatements(ast)) {
    if (statement.type !== "ExportNamedDeclaration" || !getNode(statement, "source")) {
      continue;
    }
    const importPath = getString(getNode(statement, "source"), "value");
    for (const specifier of getNodes(statement, "specifiers")) {
      const exported = getString(getNode(specifier, "exported"), "name") ?? getString(getNode(specifier, "exported"), "value");
      if (exported !== exportName) {
        continue;
      }
      const imported = getString(getNode(specifier, "local"), "name") ?? getString(getNode(specifier, "local"), "value");
...
var resolveComponentDeclaration = ({
  exportName,
  filePath,
  project,
  visited
...
var resolveCompositionComponent2 = ({
  compositionFile,
  compositionId,
  project
}) => {
  ...
  const compositionElement = findCompositionElement2({
    ast: registrationAst,
    compositionId
  });
  if (!compositionElement) {
  ...
  const lazyImportPath = findDynamicImport(getJsxAttribute(compositionElement, "lazyComponent"));
  ...
  if (lazyImportPath) {
    ...
    const componentName = jsxAttributeIdentifier(getJsxAttribute(compositionElement, "component"));
    if (!componentName) {
      throw new Error(`Could not find a component prop for composition "${compositionId}"`);
    }
...
var applyTextEdits = (source, edits) => {
  const sorted = [...edits].sort((a2, b13) => b13.start - a2.start);
  let output = source;
...
var insertSolidIntoSource = ({
  ...
  const openingElement = root.type === "JSXElement" ? getNode(root, "openingElement") : null;
  const isSelfClosing = openingElement?.selfClosing === true;
  const sequenceImport = isSelfClosing || from !== null ? chooseLocalName({
    ast,
...
var getNodePathRemappings2 = ({
  ...
  const before = [];
  const after = [];
  recast22.visit(astBefore, {
    visitJSXOpeningElement(path) {
      before.push({
        nodePath: getNodePathForRecastPath(path, astBefore),
        signature: recast22.print(path.node).code
      });
      return this.traverse(path);
    }
  });
  recast22.visit(astAfter, {
    visitJSXOpeningElement(path) {
      after.push({
  ...
  return before.flatMap(({ nodePath, signature }) => {
...
var insertSolidIntoProjectWithNodePathRemappings = ({
  ...
  const resolved = resolveCompositionComponent2({
    compositionFile: request.compositionFile,
    compositionId: request.compositionId,
    project
  });
  ...
  for (const [filePath, source] of Object.entries(project.files)) {
    ...
    try {
      ...
      visit3(ast, (node) => {
        ...
        if (!openingElement || jsxName(getNode(openingElement, "name")) !== "Folder") {
          return false;
        }
